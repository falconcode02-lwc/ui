...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () =>
      import("./pages/workflow-history-compact/workflow-history-compact-route").then(
        (m) => m.WORKFLOW_HISTORY_COMPACT_ROUTES,
      ),
  },
  {
  ...
  },
  {
    ...
    canActivate: [authGuard],
    loadChildren: () =>
      import("./pages/workspace/workspace-list/workspace-list.routes").then(
